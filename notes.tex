...
\begin{align}
    ...
    \\ \bar{c} &= \sqrt{\frac{8 \hat{R} T_{tr}}{ \mathcal{M}_s \pi}}
    \\ \sigma &=  3 \times 10^{-21} \bp{\frac{50000}{T_{tr}}}^2
    \\ n &= \frac{p}{k_b T_{tr}}
\end{align}
...
\begin{align}
    ...
    \\ &= \bb{\pd{}{T_c} \bp{C_c T_f^\eta e^{-E_a / T}}} \pd{T_c}{T} \pd{T}{U_j}
    \\ &= \bb{\eta C_c T_c^{\eta - 1} e^{-E_a / T} + C_c T_c^\eta e^{-E_a / T} E_a T_c^{-2}} \pd{T_c}{T} \pd{T}{U_j}
    \\ &= \bcb{\gamma(T_c) \bb{\frac{\eta}{T_c} + \frac{E_a}{T_c^2}} T_c \frac{q}{T}} \pd{T}{U_j} 
    \\ &= \gamma(T_c) \bb{\pd{T}{U_j} \bp{\frac{\eta q}{T} + \frac{E_a q}{T_c T}} }
\end{align}
...
\begin{multline}
    ...
    \\ + \rho_s \bcb{ \bb{\pd{}{U_j} (e_{vs}^* - e_{vs})} \frac{1}{\tau_s} + (e_{vs}^* - e_{vs})  \bp{-\tau_s ^{-2} \underbracket{\bb{\pd{}{U_j} \tau_s}}_{\text{frightening}}}}
\end{multline}
