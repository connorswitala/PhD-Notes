...
Per Scoggins, the most useful derivatives are the ones of pressure. His notation is:
...
Let us begin with $\phi_j$ using the classic equation of state for a mixture of ideal gases:
...
\begin{equation*}
    \rho R_\text{mix} = \sum_s \rho_s R_s
\end{equation*}

In order to continue, we must find the derivatives of the translational temperature with respect to the conserved variables. This is done by using the definition of the translational energy:
...
We first work on this equation, taking derivatives with respect to conserved variables:
