...
\begin{equation*}
    p = \rho R_\text{mix} T_\text{tr} = \frac{R_\text{mix}}{c_{v, \text{mix}}^\text{tr}} \bb{\rho e^\text{tr}} = \frac{R_\text{mix}}{c_{v, \text{mix}}^\text{tr}} \bb{\rho E - \frac{\rho}{2} u_r^2 - \rho e^{ve} - \sum_s \rho_s h_s^f}
\end{equation*}
...
\begin{equation*}
    \rho E = \frac{c_{v, \text{mix}}^\text{tr}}{R_\text{mix}} p + \frac{1}{2} \rho u_r^2 + \rho e^{ve} + \sum_s \rho_s h_s^f
\end{equation*}
...
\begin{equation*}
    \pd{\boldsymbol{U}}{\boldsymbol{V}} = \begin{bmatrix}
        ...
        e_{ve} & \dots & e_{ve} & 0 & 0 & \rho & 0 \\
        \pd{\rho E}{\rho_s} & \dots & \pd{\rho E}{\rho_s} & \pd{\rho E}{u_r} & \pd{\rho E}{u_\theta} & \pd{\rho E}{e_{ve}} & \pd{\rho E}{p}
    \end{bmatrix}
\end{equation*}
...
\begin{equation*}
    \pd{\boldsymbol{V}}{\boldsymbol{U}} = \begin{bmatrix}
        ...
        -\frac{e_{ve}}{\rho} & \dots & -\frac{e_{ve}}{\rho} & 0 & 0 & \frac{1}{\rho} & 0 \\
        \pd{p}{\rho_s} & \dots & \pd{p}{\rho_s} & \pd{p}{(\rho u_r)} & \pd{p}{(\rho u_\theta)} & \pd{p}{(\rho e_{ve})} & \pd{p}{(\rho E)}
    \end{bmatrix}
\end{equation*}
...
\begin{equation*}
    \pd{\boldsymbol{F^c}}{\boldsymbol{V}} = \begin{bmatrix}
        ...
        u_r e_{ve} & \dots & u_r e_{ve} & \rho e_{ve} & 0 & \rho u_r & 0 \\
        \pd{\rho E}{\rho_s} u_r & \dots & \pd{\rho E}{\rho_s} u_r & \Phi & \pd{\rho E}{u_\theta} u_r & \pd{\rho E}{e_{ve}} u_r & \Theta
    \end{bmatrix}
\end{equation*}
...
\begin{align*}
    ...
    \\ \pd{p}{\rho u_\theta} &= 0
    \\ \pd{p}{\rho e^{ve}} &= -\frac{R_\text{mix}}{c_v^\text{mix}}
    \\ \pd{p}{\rho E} &= \frac{R_\text{mix}}{c_v^\text{mix}}
\end{align*}

\begin{align*}
    \pd{\rho E}{\rho_s} &= \bb{c_{v,s} - \frac{c_v^\text{mix}}{R_\text{mix}} R_s} T_\text{tr} + \frac{u_r^2}{2} + e_{ve} + h_s^\circ
...
The left and right matrix of eigenvectors are:
...
\begin{equation*}
    L \pd{V}{U} = \begin{bmatrix}
        1 - \frac{Y_s p_{\rho_s}}{a^2} & - \frac{Y_s p_{\rho_j}}{a^2} & - \frac{Y_s p_{\rho_j}}{a^2} & -\frac{Y_s}{a} p_{\rho u_r} & -\frac{Y_s}{a} p_{\rho u_\theta} & -\frac{Y_s}{a} p_{\rho e_v} & -\frac{Y_s}{a} p_{\rho E} \\
        - \frac{Y_s p_{\rho_j}}{a^2} & \ddots & - \frac{Y_s p_{\rho_j}}{a^2} &  -\frac{Y_s}{a} p_{\rho u_r} & -\frac{Y_s}{a} p_{\rho u_\theta} & -\frac{Y_s}{a} p_{\rho e_v} & -\frac{Y_s}{a} p_{\rho E} \\
        - \frac{Y_s p_{\rho_j}}{a^2} & - \frac{Y_s p_{\rho_j}}{a^2} & 1 - \frac{Y_s p_{\rho_s}}{a^2} & -\frac{Y_s}{a} p_{\rho u_r} & -\frac{Y_s}{a} p_{\rho u_\theta} & -\frac{Y_s}{a} p_{\rho e_v} & -\frac{Y_s}{a} p_{\rho E} \\
        - \frac{u_\theta}{\rho} & \dots & - \frac{u_\theta}{\rho} & 0 & \frac{1}{\rho} & 0 & 0 \\
        - \frac{e_v}{\rho} & \dots & - \frac{e_v}{\rho} & 0 & 0 & \frac{1}{\rho} & 0 \\
        \frac{1}{2 \rho a} \bb{\frac{p_{\rho_s}}{a} + 1} & \dots & 0 & - \frac{1}{2 a} & 0 & 0 & \frac{1}{2 \rho a^2} \\
        0 & \dots & 0 & \frac{1}{2 a} & 0 & 0 & \frac{1}{2 \rho a^2}
    \end{bmatrix}
\end{equation*}
