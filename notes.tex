...
\begin{equation}
    \boxed{\pd{\tau_{sr}^\text{MW}}{U_j} = -\tau_{sr}^\text{MW} \textcolor{blue}{\bb{\frac{1}{p} \pd{p}{U_j} + \frac{1}{3} \pd{T}{U_j} T^{-4/3} A_{sr}}}}
\end{equation}

but if we want Park's correction we have:
...
\begin{multline}
    \pd{\tau_{sr}}{U_j} = -\tau_{sr}^\text{MW} \textcolor{blue}{\bb{\frac{1}{p} \pd{p}{U_j} + \frac{1}{3} \pd{T}{U_j} T^{-4/3} A_{sr}}}
...
\begin{multline}
    \boxed{\pd{<\tau_s>}{U_j} = -<\tau_s>^2  \bcb {\underbracket{\frac{\mathcal{M}}{\rho \mathcal{M}_j} \bp{\frac{1}{\tau_{sj}}  - \frac{1}{<\tau_s>}}}_{\text{when $U_j$ = $\rho_j$}} - \sum_{r=1}^\text{NS} \bb{ \frac{X_r}{\tau_{sr}^2} \pd{\tau_{sr}}{U_j}} }}
\end{multline}
