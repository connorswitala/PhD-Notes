...
We now aim to find the partical derivatives of the relaxation time:

\begin{equation}
    \pd{}{U_j} <\tau_s> = \pd{}{U_j} \frac{\sum X_r}{\sum X_r / \tau_{sr}}
\end{equation}

This gives:

\begin{eqnarray}
    \pd{}{U_j} <\tau_s> = \pd{}{U_j} \bb{\sum_r X_r} \frac{1}{\sum_r X_r / \tau_{sr}} + \sum_r X_r \pd{}{U_j} \bb{\sum_r X_r / \tau_{sr}}^{-1}
\end{eqnarray}
