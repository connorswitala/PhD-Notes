...
\begin{multline}
    \pd{<\tau_s>}{U_j} = -\bb{\sum_{r=1}^\text{NS} X_r} \bb{\sum_{r=1}^\text{NS} \frac{X_r}{\tau_{sr}}}^{-2} \times \dots
    \\ \left\{ \underbracket{\frac{\mathcal{M}}{\rho \mathcal{M}_j} \bb{\frac{1}{\tau_{sr}}  - \sum_{r=1}^\text{NS} \frac{X_r}{\tau_{sr}}}}_{\text{when $U_j$ = $\rho_j$}} - \sum_{r=1}^\text{NS} \bb{X_r \tau_{sr}^{-2} \pd{\tau_{sr}}{U_j}} \right\}
\end{multline}
...
\begin{multline}
    \boxed{\pd{<\tau_s>}{U_j} = -<\tau_s>^2  \bcb {\underbracket{\frac{\mathcal{M}}{\rho \mathcal{M}_j} \bp{\frac{1}{\tau_{sr}}  - \frac{1}{<\tau_s>}}}_{\text{when $U_j$ = $\rho_j$}} - \sum_{r=1}^\text{NS} \bb{ \frac{X_r}{\tau_{sr}^2} \pd{\tau_{sr}}{U_j}} }}
\end{multline}
